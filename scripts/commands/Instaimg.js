...
module.exports.run = async function({ api, event, args }) {
  ...
  if (!args[1]) api.sendMessage(`𝐃𝐎𝐖𝐍𝐋𝐎𝐀𝐃𝐈𝐍𝐆 𝗣𝗛𝗢𝗧𝗢 𝐅𝐎𝐑 𝐘𝐎𝐔\n\n𝐏𝐋𝐄𝐀𝐒𝐄 𝐖𝟖...`, event.threadID, (err, info) => setTimeout(() => { api.unsendMessage(info.messageID) }, 20000));

 try { 
  let data = await axios.get(`https://main-server.nayan-api.repl.co/nayan/insdown?url==${content}`);
    
  var file = fs.createWriteStream(__dirname + '/cache/insta.jpg');
  ...
  file.on('finish', () => {
    ...
    setTimeout(function() {
      ...
      return api.sendMessage({
        body: `====[ 𝗜𝗡𝗦𝗧𝗔𝗚𝗥𝗔𝗠 𝗣𝗛𝗢𝗧𝗢 ]====\n━━━━━━━━━━━━━━━━━━━━━\n\n📱 𝐍𝐈𝐂𝐊𝐍𝐀𝐍𝐄: ${n}\n🎐 𝐔𝐒𝐄𝐑 𝐍𝐀𝐌𝐄: @${u}\n💭 𝐂𝐎𝐌𝐌𝐄𝐍𝐓: ${c}\n✔️𝗟𝗜𝗞𝗘: ${l}\n💬 𝗧𝗶𝘁𝗹𝗲: ${t}`,
        attachment: fs.createReadStream(__dirname + '/cache/insta.jpg')
      }, threadID, messageID)
    }, 5000)
  })
    } catch (err) {
