...
const nam = [{
    timer: '12:00:00 AM',
    message: ['~ এখন রাত ১১টা বাজে\n আমার বস সামির এর gf নাই তার ঘুম আসে না😙']
},
             {
    timer: '1:00:00 AM',
    message: ['~ এখন রাত ১২টা বেজে এখন সবাই প্রেম করো আমার বস সিঙ্গেল 🥺🤟']
},
						{
    timer: '2:00:00 AM',
    message: ['~এখন রাত ১টা বাজে প্রেম না কইরা যাইয়া ঘুমা আর আমার বস এর তো ঘুম nেই😾']
},
						 {
    timer: '3:00:00 AM',
    message: ['~এখন রাত ২টা বাজে যারা ছ্যাকা খাইছে তারা জেগে আছে আমার বস ঘুমায় na এখনও🫠🫠।']
},
						 {
    timer: '4:00:00 AM',
    ...
    message: ['~এখন সকাল ১০টা বাজে মিস করছি তোমাদের  ']
						 ...
						 {
    timer: '12:00:00 PM',
    message: ['~এখন সকাল ১১টা বাজে সবাই এখন fb তে']
},					
						 {
    timer: '1:00:00 PM',
    message: ['~এখন দুপুর ১২টা বাজে এখন সবার একটু খিদে লেগেছে রোজা ভানগো না❤️ ']
},
						 {
    timer: '2:00:00 PM',
    message: ['~এখন দুপুর ১টা বাজে সবাই কাজ বন্ধ করে জোহরের নামাজ পড়ে নাও😻 ']
						 ...
						 {
    timer: '3:00:00 PM',
    message: ['~এখন দুপুর ২টা বাজে গোসল করে সবাই এখন ফোন চালাইতাসো ☺️']
},
						 {
    timer: '4:00:00 PM',
    ...
    message: ['~ এখন বিকাল ৪টা বাজে আসরের আযান দিলে সবাই নামাজ পড়ে নাও🥀 ']
						 ...
						 {
    timer: '6:00:00 PM',
    message: ['~এখন বিকাল ৫টা বাজে সবাই কি ইফতার রেডী করতেসে 😻']
},
						 {
    timer: '7:00:00 PM',
    message: ['~এখন সন্ধ্যা ৬টা বাজে সবাই এখন ইফতার খেয়ে নেও😍. ']
},
             {
    timer: '8:00:00 PM',
    message: ['এখন সন্ধ্যা ৭ টা বাজে কি করছো সবাই এখন এশার আযান দিবে সবাই নামাজ পড়ে নাও❤️']
             ...
             {
    timer: '9:00:00 PM',
    message: ['~এখন রাত ৮টা বাজে সবাই তারাবি পড়তে জেলা নাকি']
},
             {
    timer: '10:00:00 PM',
